package com.jaisonbrooks.football_scores.services;
...
import com.jaisonbrooks.football_scores.R;
import com.jaisonbrooks.football_scores.models.Fixture;
import com.jaisonbrooks.football_scores.models.FixturesResponse;
import com.jaisonbrooks.football_scores.models.HrefWrapper;
import com.jaisonbrooks.football_scores.models.Season;
import com.jaisonbrooks.football_scores.models.Team;
import com.jaisonbrooks.football_scores.models.TeamResponse;
import com.jaisonbrooks.football_scores.network.FootballApi;
import com.jaisonbrooks.football_scores.providers.ScoresContract;
...
public final class FetchService extends IntentService {
    ...
    public static final String BROADCAST_DATA_UPDATED = "com.jaisonbrooks.football_scores.BROADCAST_DATA_UPDATED";
        ...
        final RestAdapter restAdapter = new RestAdapter.Builder()
                ...
                .setRequestInterceptor(new RequestInterceptor() {
                    @Override public void intercept(RequestFacade request) {
                        request.addHeader("X-Auth-Token", getString(R.string.api_key));
                    }
                })
                .build();
